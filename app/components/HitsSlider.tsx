...
export default function HitsSlider (
  ...
  return (
    <div className="relative mx-auto w-full">
      ...
      >
        {/* Кнопки навигации */}
        <div className="custom-prev absolute left-[-30] z-50 cursor-pointer text-black top-1/3 -translate-y-1/2 w-24 h-24">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0.3">
            <path d="M15 18l-6-6 6-6" />
          </svg>
        </div>
        <div className="custom-next absolute right-[-30] z-50 cursor-pointer text-black top-1/3 -translate-y-1/2 w-24 h-24">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0.3">
